...
So, there are **10,677** movies and **69,878** users in the edx dataset. If each user had rated each of the movies, we should have a **746,087,406** records in out dataset where as we only have **9,000,055**. We can infer from this, that not all users have rated all the movies in the dataset.  
